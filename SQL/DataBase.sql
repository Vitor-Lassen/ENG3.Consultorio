...
(
PK_CONSULTA INT PRIMARY KEY IDENTITY(1,1),
...
FK_SECRETARIA_ID BIGINT REFERENCES SECRETARIA(PK_CPFSECRETARIA),
FK_MEDICO_ID INT REFERENCES MEDICO(PK_CRM),
FK_PACIENTE_ID BIGINT REFERENCES PACIENTE(PK_CPFPACIENTE),
);

CREATE TABLE EXAME
(
PK_EXAME INT PRIMARY KEY IDENTITY(1,1),
DT_HR_INICIO DATETIME NOT NULL,
...
(
PK_MATERIAL INT PRIMARY KEY IDENTITY(1,1),
NOME VARCHAR(30) NOT NULL,
);

CREATE TABLE CONSULTA_MATERIAL
(
PK_CONSULTA_MATERIAL INT PRIMARY KEY IDENTITY(1,1), 
FK_CONSULTA_ID INT REFERENCES CONSULTA(PK_CONSULTA),
...
(
PK_EXAME_MATERIAL INT PRIMARY KEY IDENTITY(1,1),
